...
logger = logging.getLogger("init_cooking_agent")
...
INIT_PROMPT = """당신은 스마트홈 쿠킹 도우미입니다. 아래 정보를 반드시 파악해야 합니다:
- 사용자의 음식/재료 선호도
- 냉장고 속 식재료 목록
- 사용 가능한 주방기기 목록
필요한 정보를 tools를 통해 계속 확인하고, 레시피를 사용자 맞춤으로 리플랜하세요.
"""
...
async def get_init_cooking_agent():
